...
namespace Examen_P1.Controllers
{
    ...
    {
        private readonly DataB_MolinaM _context;

        public DueñoController(DataB_MolinaM context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Presupuesto,FechaNacimiento,MolinaM")] Dueño dueño)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Presupuesto,FechaNacimiento,MolinaM")] Dueño dueño)
        {
            if (id != dueño.Id)
            {
                return NotFound();
